...
export default {
  ...
  created(){		
    ...
    // });
		...
		// console.log('this.examinesData',this.examinesData)
  ...
  methods: {
    ...
    // },
    drawBarChart () {
      let barChart = this.$echarts.init(document.getElementById('verifyChart'))  
      barChart.setOption({
        title: {					         	
					text: '小区本周核查数',                
					textStyle:{				
