<template>
    <div class="jdClass">
      <el-row class="app-container">
        <el-col :span="24">
          <div class="table-control-panel">
            <span class="control-left list-title">核酸检测记录</span>
                    ...
                    <el-row :gutter="20" v-if='checkoutSearch'>
                      ...
                      <el-col :span="12">
                        <el-form-item label="条码编号" prop="barCode">
                          <el-input placeholder="请输入" clearable v-model="searchForm.barCode"/>
                        </el-form-item>
                      </el-col>
                    </el-row>

                    <el-row v-if='checkoutSearch'>
                      <el-col :span="24">
      ...
      <div v-if="contentVisible">
        <div class="header">
          <el-row :gutter="20">
            <el-col :span="4" class="JdClassItem onClass">
              <div class="no-sync" :class="{'checked': searchForm.statusId==1}" @click="repairStatusChg(1)">
                未分配
                <div>
            ...
            <el-col :span="4" class="JdClassItem offClass">
              <div class="ccc" :class="{'checked': searchForm.statusId==2}" @click="repairStatusChg(2)">
                ...
                <!-- <el-tooltip class="item" effect="dark" placement="top" >
                  <div slot="content" style="padding:5px">统计项统计该设备当天录入分配的居民数量，<br>列表只显示当前账号分配的居民</div>
                  <i class="el-icon-question" style="position: absolute;left:0px;top:0px;"></i>
                </el-tooltip> -->
              </div>
            </el-col>
            <el-col :span="8" class="searchBtn">
              ...
              <el-button v-if="searchForm.statusId==2" @click="excelExportBTN" type="primary" style="background: #fff;border-color: #007EE4;color: #007EE4;">导出</el-button>
            </el-col>
          </el-row>
        </div>
        <el-row>
      ...
      <el-dialog
        ...
        :closeOnClickModal="false"
        width="400px">
          <el-form :model="Form" :rules="rules" ref="Form" v-loading="loading" label-position="top" @submit.native.prevent>
