      ...
      <el-row :span="24">
        <el-col>
          <div class="table-control-panel">
            <span class="control-left list-title">门禁机公告列表</span>
                    ...
                    <el-row :gutter="20">
                      ...
                      <el-col :span="12">
                        <el-form-item label="公告标题" prop="key">
                          <el-input placeholder="请输入" clearable v-model="searchForm.key" :maxlength="16"/>
                        </el-form-item>
                      </el-col>
                    </el-row>
...
<el-dialog title="温馨提醒" width="400px" :visible.sync="showDelDiglogFlag">
    ...
    <div v-if="showModal">
      <el-dialog
        ...
        <device-form preview="device" :communityId="communityId"/>
      </el-dialog>
    </div>
...
<script>
  ...
  import noticeView from "./components/deviceView.vue";
  import {delNotice, fetchDevice} from "@/api/notice";
  ...
  export default {
    ...
    methods: {
      ...
      loadData: function (offset=0, limit=10) {
        ...
        fetchDevice(self.searchForm).then(function (response) {
